...
def _add_central_dp_noise(global_state, averaged_state, args, selected_count,
    ...
    default_noise_std = effective_multiplier * clip_norm * aggregation_max_weight
    ...
    for key, avg_tensor in averaged_state.items():
        ...
        alg_std = alg_multiplier * key_clip_norm * aggregation_max_weight
        ch_std = channel_multiplier * key_clip_norm * aggregation_max_weight
