#!/bin/bash
#SBATCH --job-name=FLSV_gca_alpha
#SBATCH --partition=p3
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=4
#SBATCH --mem=16G
#SBATCH --time=72:00:00
#SBATCH --output=/data/home/zhaozhanshan/FLSV/logs/slurm_gca_alpha_%j.out
#SBATCH --error=/data/home/zhaozhanshan/FLSV/logs/slurm_gca_alpha_%j.err
...
echo "Start: $(date)"
echo "Task: GCA baseline for Dirichlet-alpha sensitivity"
echo "========================================"
...
RUN_TAG="${RUN_TAG:-20260621_152056}"
...
echo "  Output root: ${PROJECT_ROOT}/save/sensitivity_multiseed/${RUN_TAG}/alpha"
echo "========================================"
...
for ALPHA in "${ALPHAS[@]}"; do
    for SEED in "${SEEDS[@]}"; do
        OUT="sensitivity_multiseed/${RUN_TAG}/alpha/alpha${ALPHA}/seed${SEED}/gca"
        run_cmd "GCA alpha=${ALPHA}, seed=${SEED}" "${OUT}" \
...
echo ""
echo "========================================"
echo "GCA alpha sensitivity finished!"
echo "Results root: ${PROJECT_ROOT}/save/sensitivity_multiseed/${RUN_TAG}/alpha"
echo "End: $(date)"
echo "========================================"
