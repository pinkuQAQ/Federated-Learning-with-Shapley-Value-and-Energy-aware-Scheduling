#!/bin/bash
#SBATCH --job-name=FLSV_oort_faithful
#SBATCH --partition=p3
#SBATCH --gres=gpu:1
...
#SBATCH --array=0-3%4
#SBATCH --output=/data/home/zhaozhanshan/FLSV/logs/slurm_oort_faithful_%A_%a.out
#SBATCH --error=/data/home/zhaozhanshan/FLSV/logs/slurm_oort_faithful_%A_%a.err
...
# The ten paired seeds used by the main significance experiment.
...
OORT_ARGS=(
    ...
    --oort_pacer_window 20 --oort_pacer_delta 5 --oort_round_threshold 10
    --oort_straggler_penalty 2.0 --oort_cutoff_util 0.95
    --oort_clip_percentile 95 --oort_blacklist_rounds 10
...
echo "Start: $(date)"
echo "Oort source-faithful matched-protocol rerun"
echo "Seeds: ${SEEDS[*]}"
...
for index in "${!SEEDS[@]}"; do
    ...
    SEED=${SEEDS[${index}]}
    OUT="oort_faithful/${RUN_TAG}/seed${SEED}"
...
echo "Results: ${PROJECT_ROOT}/save/oort_faithful/${RUN_TAG}"
echo "All four array workers together produce the ten Oort seeds."
echo "========================================"
