#!/bin/bash
#SBATCH --job-name=FLSV_align
#SBATCH --partition=p3
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=4
#SBATCH --mem=16G
#SBATCH --time=120:00:00
#SBATCH --output=/data/home/zhaozhanshan/FLSV/logs/slurm_align_%j.out
#SBATCH --error=/data/home/zhaozhanshan/FLSV/logs/slurm_align_%j.err
...
echo "Start: $(date)"
echo "Task: Paper-alignment rerun after scheduler and accounting fixes"
echo "========================================"
...
# TASK_GROUP: core, sensitivity, cross, or all.
TASK_GROUP=${TASK_GROUP:-core}
...
echo ""
echo "========================================"
echo "Paper-alignment rerun finished"
